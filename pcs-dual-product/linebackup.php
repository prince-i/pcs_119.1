					...
					<div class="card-body">
						...
						?>
							...
							<div class="row justify-content-start">
								<div class="col-lg-10 section-B">
									<div class="row">
										<div class="col-lg-6 text-right labs">PLAN</div>
										<div class="col-lg-6 plan-value vals">0</div>
									</div>
									<div class="row">
										<div class="col-lg-6 text-right labs">ACTUAL</div>
										<div class="col-lg-6 actual-value vals">0</div>
									</div>
									<div class="row">
										<div class="col-lg-6 text-right labs">DIFFERENCE</div>
										<div class="col-lg-6 remaining-value vals">0</div>
									</div>
								</div>
							</div>
