...
if(isset($_POST['request'])){
	...
	if($request == "getPlan"){
		...
		$status = "Pending";
		$sql = "INSERT INTO pcs_plan (Carmodel, Line, Target, Status, IRCS_Line, datetime_DB, takt_secs_DB, actual_start_DB, last_update_DB, IP_address,theme) VALUES ('".$car_maker."','".$line_name."','".$plan."','".$status."', '".$registlinename."', NOW(), ".$takt_secs.", '".$time_start."', NOW(), '$IP_address','$parts')";
		if($db->execQuery($sql)){
